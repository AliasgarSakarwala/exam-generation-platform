...
**Team Number:** 3 <br>
**Team Members:** Ali Afoud, Sahil Chawla, Samyak Jain, Arjun Sampat, Christian Eziekwu, Aliasgar Sakarwala, Cooper Ross
...
**THIS PLAN REPRESENTS AN INITIAL PROJECTION AND MAY EVOLVE OVER TIME. ADJUSTMENTS OR ACCELERATION ARE EXPECTED AS TEAM EFFICIENCY IMPROVES AND REQUIRED COMPETENCIES AND SKILLS ARE DEVELOPED.**

## Teamwork Planning and Anticipated Hurdles

| Category            | Ali Afoud                                                                                                                                                                 | Sahil Chawla | Samyak Jain                                                                               | Arjun Sampat                                  | Christian Eziekwu                                                                                                                               | Aliasgar Sakarwala                                | Cooper Ross                                                                                                       |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ----------------------------------------------------------------------------------------- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| **Experience**      | - Project in COSC 310 <br> - Vanilla CSS <br> - Vanilla JS                                                                                                                | - PHP <br>Laravel <br> - PHP Unit Testing              | - NextJS <br> Other JS Libraries <br> - CI/CD <br> - Git                                  | - Git<br>- NextJS<br>- CSS<br>- CI/CD         |                                                                                                                                                -Java, JSON, PHP, HTML/CSS <br>-Git |                                                   | - Java <br> - Simple JS <br> - CCS                                                                                |
| **Good At**         | - Planning <br> - Project management <br> - Back end logic <br> - fast learning                                                                                           | - Back end logic <br> - Databases <br> - Logical reasoning             | - Frontend Development (NextJS or Other JS Libraries) <br> - Git <br> - Logical Reasoning | - Component Testing (UI)<br>- Web development |                                                                                                                                                - Java <br> - Logic (Backend) <br> -Git <br> HTML/CSS |                                                   | - CCS Aesthetics <br> - HTML <br> - Java                                                                          |
| **Expect to Learn** | - Mastery of Docker <br> - Advance skilsl with backend frameworks (php laravel) <br> - Advanced understanding of project development process, planning and infrastructure | - UI Design <br> - Docker <br> - Understanding of project development <br> - React            | - Laravel <br> - PHP as backend                                                           | - PHP as back-end<br>- Laravel<br>- PHPUnit   | - Data security/Web security <br> - CI&CD <br> - Next.JS <br> - Docker <br> - Laravel | Don’t ever leave this blank! We are all learning. | I expect to learn some more complex front end coding including JS and Laravel, and hopefully some backend coding. |

| Category of Work/Features                                                                  | Ali Afoud | Sahil Chawla | Samyak Jain | Arjun Sampat | Christian Eziekwu | Aliasgar Sakarwala | Cooper Ross |
| ------------------------------------------------------------------------------------------ | :-------: | :----------: | :---------: | :----------: | :---------------: | :----------------: | :---------: |
...
| **Search feature**                                                                         |           |              |     ✅      |              |                  ✅  |                 ✅    |             |
| **Classroom creation**                                                                     |           |              |     ✅      |      ✅      |                  ✅  |                    |             |
| **Classroom creation backend**                                                             |    ✅     |              |     ✅      |              |                 ✅   |                    |             |
| **Archiving back end**                                                                     |    ✅     |              |     ✅      |              |                   |                    |             |
| **Classroom creation testing**                                                             |           |              |             |      ✅      |                ✅    |                    |     ✅      |
| **Archiving testing**                                                                      |           |              |             |      ✅      |                   |                    |             |
...
| **Exam download feature**                                                                  |           | ✅             |     ✅      |      ✅      |                   |                    |             |
| **Exam DB update**                                                                         |    ✅     |              |             |              |                ✅    |                    |             |
| **Question bank feature**                                                                  |           |              |             |              |                  ✅  |                    |             |
| **Importing excel to Q-bank**                                                              |           |     ✅         |             |              |                   |                    |             |
| **Student list UI**                                                                        |           |              |     ✅      |      ✅      |                   |                    |     ✅      |
| **Student list DB connection**                                                             |    ✅     |              |     ✅      |              |                ✅    |                  ✅   |             |
| **Student list Dynamic update**                                                            |    ✅     |              |     ✅      |              |                 ✅   |                  ✅   |             |
...
| **<...More features>** _to be updated with new features and element as project progresses_ |           |              |             |              |                  ✅  |                    |             |
| **Design Report**                                                                          |           |              |     ✅      |      ✅      |                   |         ✅         |             |
| **Final Team Report**                                                                      |    ✅     |      ✅      |     ✅      |      ✅      |        ✅         |         ✅         |     ✅      |
